...
--6. Write a query that uses the WHERE clause to filter for employees with Salary >= 60000 and Department = 'HR'.
 ...
 SELECT * FROM Employees
SELECT *,ISNULL(EMAIL,NULL) FROM Employees
...
--14. Write a query that filters the Employees table to show employees whose Age is either between 30 and 40 or, = 'Marketing'.
...
SELECT * FROM  employees
where employees LIKE 'HR', 'IT', or 'Finance'
